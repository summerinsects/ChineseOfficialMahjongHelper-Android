...
public class RuleBottomSheetDialog extends BottomSheetDialogFragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        contentView.findViewById(R.id.rbs_txt_supplement).setOnClickListener(view -> {
            Intent intent = new Intent(getActivity(), RuleSupplementActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            startActivity(intent);
